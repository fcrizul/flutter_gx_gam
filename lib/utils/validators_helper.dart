...
abstract class ValidatorsHelper {
  ...
  static const String PATTERN_URL =
      "^([0-9a-zA-Z]([-.+\\w]*[0-9a-zA-Z])*@([0-9a-zA-Z][-\\w]*[0-9a-zA-Z]\\.)+[a-zA-Z]{2,9})\$";
  ...
  static const String PATTERN_COORDINATES =
  ...
  static bool isUrl(String input) {
    if (!Uri.parse(input).isAbsolute) return false;
    return true;
  }

  static bool isEmail(String input) {
    if (!isMatchPattern(input, PATTERN_EMAIL)) return false;
    return true;
  }

  static bool isCoordinates(String input) {
    if (!isMatchPattern(input, PATTERN_COORDINATES)) return false;
    return true;
  }

  static bool isJson(String jsonString) {
    try {
      var decode = json.decode(jsonString) as Map<String, dynamic>;
      return (decode != null);
